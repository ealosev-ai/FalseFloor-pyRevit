...
Каждому семейству добавляются только релевантные параметры:
  ...
  ФП_Лонжерон                  → параметры лонжерона
...
FAMILY_PARAMS = [
    ...
    ("FP_Тип_Лонжерона", StorageType.String, "Тип лонжерона (Верхний/Нижний)", True),
    ...
    ("FP_Вырез_Видимость", "YesNo", "Видимость выреза (Да/Нет)", True),
    # Type
